...
/*   Updated: 2016/09/18 22:56:37 by jubarbie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_textures(t_env *e)
{
	...
	while (++i < NB_TEX)
		if (!(TEX[i] = malloc(sizeof(t_tex))))
			exit(EXIT_FAILURE);
	TX_IM(0) = mlx_xpm_file_to_image(MLX, "Img/walltest3.xpm", &TXW(0), &TXW(0));
	...
	TX_IM(4) = mlx_xpm_file_to_image(MLX, "Img/floor.xpm", &TXW(4), &TXW(4));
	TX_IM(5) = mlx_xpm_file_to_image(MLX, "Img/floor9.xpm", &TXW(5), &TXW(5));
	TX_IM(6) = mlx_xpm_file_to_image(MLX, "Img/top1.xpm", &TXW(6), &TXW(6));
	TX_IM(7) = mlx_xpm_file_to_image(MLX, "Img/floor11.xpm", &TXW(7), &TXW(7));
	TX_IM(8) = mlx_xpm_file_to_image(MLX, "Img/cielling6.xpm", &TXW(8), &TXW(8));
	TX_IM(9) = mlx_xpm_file_to_image(MLX, "Img/bosch1.xpm", &TXW(9), &TXW(9));
	TX_IM(10) = mlx_xpm_file_to_image(MLX, "Img/bosch2.xpm", &TXW(10), &TXW(10));
	TX_IM(11) = mlx_xpm_file_to_image(MLX, "Img/bosch3.xpm", &TXW(11), &TXW(11));
	...
	TX_IM(18) = mlx_xpm_file_to_image(MLX, "Img/floorex.xpm", &TXW(18), &TXW(18));
	while (--i >= 0)
